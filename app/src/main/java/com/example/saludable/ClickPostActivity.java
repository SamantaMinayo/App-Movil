...
public class ClickPostActivity extends AppCompatActivity {
    ...
    private DatabaseReference ClickcPostRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ClickcPostRef = FirebaseDatabase.getInstance ().getReference ().child ( "Posts" ).child ( PostKey );
        ...
        ClickcPostRef.addValueEventListener ( new ValueEventListener () {
            @Override
    ...
    private void EditCurrentPost(String description) {
        ...
        builder.setPositiveButton ( "Update", new DialogInterface.OnClickListener () {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ClickcPostRef.child ( "description" ).setValue ( inputField.getText ().toString () );
